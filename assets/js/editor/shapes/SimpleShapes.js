...
.service('simpleShapes', ['$rootScope', 'canvas', 'polygon', 'history', function ($rootScope, canvas, polygon, history) {
    ...
    shapes.available.push({
        ...
        var qrOptions = angular.copy(shapes.baseOptions);
        qrOptions.main.width = { type: 'slider', current: 100 };
        qrOptions.main.height = { type: 'slider', current: 100 };

// slamet 15/09/2020 Penambahan menu baru
    // shapes.available.push({
    //     name: 'qrcode',  options: angular.copy(shapes.baseOptions), service: qrcode
    // });
    //displayName: 'qrcode',
    //  shapes.available.push({
    //     name: 'qrcode',  options: angular.copy(shapes.baseOptions), service: polygon
    // });
