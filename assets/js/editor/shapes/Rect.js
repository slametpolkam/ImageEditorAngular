...
.service('rect', ['$rootScope', '$mdDialog', 'canvas', function ($rootScope, $mdDialog, canvas) {
    ...
    var self = {
        ...
        onMouseDown: function(event) {
            ...
            if (self.mode === "add") {
                ...
                qrOptions.main.width = { type: 'slider', current: 200 };
                qrOptions.main.height = { type: 'slider', current: 200 };

                self.currentShape.name = 'rect';
